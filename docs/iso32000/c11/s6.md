...
=== "中文"
    ...
    - For objects defined by a path or a glyph and painted in a uniform colour with a path-painting or text-showing operator (“[Path-Painting Operators](../c8/s5.md#853-路径绘制运算符)”, and “[Text-Showing Operators](../c9/s4.md#943-文本显示运算符)”), the shape shall always be 1.0 inside and 0.0 outside the path.
