...
=== "中文"
    ...
    Documents containing tag suspects shall contain a Suspects entry with a value of true in the mark information dictionary (see [Table 321](#table321)).
...
=== "中文"
    ...
    - As entries in the structure element dictionary (see [Table 323](#table323))
